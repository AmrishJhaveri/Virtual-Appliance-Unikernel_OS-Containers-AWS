...
public class Game
{
    ...
    private static final Logger LOG = Logger.getLogger(Game.class.toString());
...
//    private HistoryButtons historyButtons;
    ...
    public Game(String name,String colour)
    {
    ...
    protected final void init(Player outsidePlayer, Player insidePlayer)
    {
//        this.setLayout(null);
//        this.chat = new Chat();
        this.settings = new Settings(outsidePlayer,insidePlayer);
